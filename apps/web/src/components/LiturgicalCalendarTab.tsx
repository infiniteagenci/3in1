...
class LiturgicalCalendar {
  ...
  static getFixedFeasts(month: number, day: number): Celebration | null {
    const fixedFeasts: Record<string, Celebration> = {
      ...
      '1-2': { name: 'Sts. Basil the Great and Gregory Nazianzen', rank: 'memorial', color: 'white' },
      '1-3': { name: 'Most Holy Name of Jesus', rank: 'memorial', color: 'white' },
      '1-5': { name: 'St. John Neumann', rank: 'memorial', color: 'white' },
      '1-6': { name: 'Epiphany of the Lord', rank: 'solemnity', color: 'white' },
      '1-7': { name: 'St. Raymond of Peñafort', rank: 'memorial', color: 'white' },
      '1-13': { name: 'St. Hilary', rank: 'memorial', color: 'white' },
      '1-17': { name: 'St. Anthony of Egypt', rank: 'memorial', color: 'white' },
      '1-20': { name: 'St. Fabian and St. Sebastian', rank: 'memorial', color: 'red' },
      '1-21': { name: 'St. Agnes', rank: 'memorial', color: 'red' },
      '1-22': { name: 'St. Vincent of Saragossa', rank: 'memorial', color: 'red' },
      '1-24': { name: 'St. Francis de Sales', rank: 'memorial', color: 'white' },
      '1-25': { name: 'Conversion of St. Paul', rank: 'feast', color: 'white' },
      '1-26': { name: 'Sts. Timothy and Titus', rank: 'memorial', color: 'white' },
      '1-28': { name: 'St. Thomas Aquinas', rank: 'memorial', color: 'white' },
      '1-31': { name: 'St. John Bosco', rank: 'memorial', color: 'white' },

      // February
      '2-1': { name: 'St. Brigid of Ireland', rank: 'memorial', color: 'white' },
      '2-2': { name: 'Presentation of the Lord', rank: 'feast', color: 'white' },
      '2-3': { name: 'St. Blaise', rank: 'memorial', color: 'red' },
      '2-5': { name: 'St. Agatha', rank: 'memorial', color: 'red' },
      '2-6': { name: 'Sts. Paul Miki and Companions', rank: 'memorial', color: 'red' },
      '2-8': { name: 'St. Jerome Emiliani', rank: 'memorial', color: 'white' },
      '2-10': { name: 'St. Scholastica', rank: 'memorial', color: 'white' },
      '2-11': { name: 'Our Lady of Lourdes', rank: 'memorial', color: 'white' },
      '2-14': { name: 'Sts. Cyril and Methodius', rank: 'memorial', color: 'white' },
      '2-21': { name: 'St. Peter Damian', rank: 'memorial', color: 'white' },
      '2-22': { name: 'Chair of St. Peter', rank: 'feast', color: 'white' },
      '2-23': { name: 'St. Polycarp', rank: 'memorial', color: 'red' },

      // March
      '3-4': { name: 'St. Casimir', rank: 'memorial', color: 'white' },
      '3-7': { name: 'Sts. Perpetua and Felicity', rank: 'memorial', color: 'red' },
      '3-9': { name: 'St. Frances of Rome', rank: 'memorial', color: 'white' },
      '3-17': { name: 'St. Patrick', rank: 'memorial', color: 'white' },
      '3-18': { name: 'St. Cyril of Jerusalem', rank: 'memorial', color: 'white' },
      '3-19': { name: 'St. Joseph', rank: 'solemnity', color: 'white' },
      '3-23': { name: 'St. Turibius of Mogrovejo', rank: 'memorial', color: 'white' },
      '3-25': { name: 'Annunciation of the Lord', rank: 'solemnity', color: 'white' },
      '3-27': { name: 'St. John Damascene', rank: 'memorial', color: 'white' },
      '3-28': { name: 'St. Stephen Harding', rank: 'memorial', color: 'white' },

      // April
      '2-4': { name: 'St. Isidore of Seville', rank: 'memorial', color: 'white' },
      '4-7': { name: 'St. John Baptist de La Salle', rank: 'memorial', color: 'white' },
      '4-11': { name: 'St. Stanislaus', rank: 'memorial', color: 'red' },
      '4-13': { name: 'St. Martin I', rank: 'memorial', color: 'white' },
      '4-21': { name: 'St. Anselm', rank: 'memorial', color: 'white' },
      '4-23': { name: 'St. George', rank: 'memorial', color: 'red' },
      '4-24': { name: 'St. Fidelis of Sigmaringen', rank: 'memorial', color: 'red' },
      '4-25': { name: 'St. Mark', rank: 'feast', color: 'red' },
      '4-28': { name: 'Sts. Louis de Montfort and Peter Chanel', rank: 'memorial', color: 'red' },
      '4-29': { name: 'St. Catherine of Siena', rank: 'memorial', color: 'white' },

      // May
      '5-1': { name: 'St. Joseph the Worker', rank: 'memorial', color: 'white' },
      '5-2': { name: 'St. Athanasius', rank: 'memorial', color: 'white' },
      '5-3': { name: 'Sts. Philip and James', rank: 'feast', color: 'red' },
      '5-10': { name: 'St. Damien of Molokai', rank: 'memorial', color: 'white' },
      '5-12': { name: 'Sts. Nereus and Achilleus', rank: 'memorial', color: 'red' },
      '5-14': { name: 'St. Matthias', rank: 'feast', color: 'red' },
      '5-16': { name: 'St. Brendan', rank: 'memorial', color: 'white' },
      '5-18': { name: 'St. John I', rank: 'memorial', color: 'white' },
      '5-20': { name: 'St. Bernardine of Siena', rank: 'memorial', color: 'white' },
      '5-22': { name: 'St. Rita of Cascia', rank: 'memorial', color: 'white' },
      '5-25': { name: 'St. Bede the Venerable', rank: 'memorial', color: 'white' },
      '5-26': { name: 'St. Philip Neri', rank: 'memorial', color: 'white' },
      '5-27': { name: 'St. Augustine of Canterbury', rank: 'memorial', color: 'white' },
      '5-31': { name: 'Visitation of the Blessed Virgin Mary', rank: 'feast', color: 'white' },

      // June
      '6-1': { name: 'St. Justin', rank: 'memorial', color: 'red' },
      '6-3': { name: 'Sts. Charles Lwanga and Companions', rank: 'memorial', color: 'red' },
      '6-5': { name: 'St. Boniface', rank: 'memorial', color: 'red' },
      '6-6': { name: 'St. Norbert', rank: 'memorial', color: 'white' },
      '6-9': { name: 'St. Ephrem', rank: 'memorial', color: 'white' },
      '6-10': { name: 'St. Barnabas', rank: 'memorial', color: 'white' },
      '6-11': { name: 'St. Barnabas', rank: 'memorial', color: 'white' },
      '6-12': { name: 'Sacred Heart of Jesus', rank: 'solemnity', color: 'white' },
      '6-13': { name: 'St. Anthony of Padua', rank: 'memorial', color: 'white' },
      '6-14': { name: 'St. Methodius', rank: 'memorial', color: 'white' },
      '6-19': { name: 'St. Romuald', rank: 'memorial', color: 'white' },
      '6-21': { name: 'St. Aloysius Gonzaga', rank: 'memorial', color: 'white' },
      '6-22': { name: 'Sts. John Fisher and Thomas More', rank: 'memorial', color: 'red' },
      '6-24': { name: 'Nativity of St. John the Baptist', rank: 'solemnity', color: 'white' },
      '6-27': { name: 'St. Cyril of Alexandria', rank: 'memorial', color: 'white' },
      '6-28': { name: 'St. Irenaeus', rank: 'memorial', color: 'white' },
      ...
      '7-5': { name: 'St. Anthony Mary Zaccaria', rank: 'memorial', color: 'white' },
      '7-6': { name: 'St. Maria Goretti', rank: 'memorial', color: 'red' },
      '7-9': { name: 'Sts. Augustine Zhao Rong and Companions', rank: 'memorial', color: 'red' },
      '7-11': { name: 'St. Benedict', rank: 'memorial', color: 'white' },
      '7-13': { name: 'St. Henry', rank: 'memorial', color: 'white' },
      '7-14': { name: 'St. Kateri Tekakwitha', rank: 'memorial', color: 'red' },
      '7-15': { name: 'St. Bonaventure', rank: 'memorial', color: 'white' },
      '7-16': { name: 'Our Lady of Mount Carmel', rank: 'memorial', color: 'white' },
      '7-20': { name: 'St. Apollinaris', rank: 'memorial', color: 'white' },
      '7-21': { name: 'St. Lawrence of Brindisi', rank: 'memorial', color: 'white' },
      '7-22': { name: 'St. Mary Magdalene', rank: 'feast', color: 'white' },
      '7-23': { name: 'St. Bridget of Sweden', rank: 'memorial', color: 'white' },
      '7-24': { name: 'St. Sharbel Makhluf', rank: 'memorial', color: 'white' },
      '7-25': { name: 'St. James', rank: 'feast', color: 'red' },
      '7-26': { name: 'Sts. Joachim and Anne', rank: 'memorial', color: 'white' },
      '7-28': { name: 'St. Alphonsus Liguori', rank: 'memorial', color: 'white' },
      '7-29': { name: 'St. Martha', rank: 'memorial', color: 'white' },
      '7-30': { name: 'St. Peter Chrysologus', rank: 'memorial', color: 'white' },
      '7-31': { name: 'St. Ignatius of Loyola', rank: 'memorial', color: 'white' },

      // August
      '8-1': { name: 'St. Alphonsus Liguori', rank: 'memorial', color: 'white' },
      '8-2': { name: 'St. Eusebius of Vercelli', rank: 'memorial', color: 'white' },
      '8-4': { name: 'St. John Vianney', rank: 'memorial', color: 'white' },
      '8-5': { name: 'Dedication of St. Mary Major', rank: 'memorial', color: 'white' },
      '8-6': { name: 'Transfiguration of the Lord', rank: 'feast', color: 'white' },
      '6-7': { name: 'St. Sixtus II and Companions', rank: 'memorial', color: 'red' },
      '8-7': { name: 'St. Cajetan', rank: 'memorial', color: 'white' },
      '8-8': { name: 'St. Dominic', rank: 'memorial', color: 'white' },
      '8-9': { name: 'St. Teresa Benedicta of the Cross', rank: 'memorial', color: 'red' },
      '8-10': { name: 'St. Lawrence', rank: 'feast', color: 'red' },
      '8-11': { name: 'St. Clare', rank: 'memorial', color: 'white' },
      '8-12': { name: 'St. Jane Frances de Chantal', rank: 'memorial', color: 'white' },
      '8-13': { name: 'Sts. Pontian and Hippolytus', rank: 'memorial', color: 'red' },
      '8-14': { name: 'St. Maximilian Kolbe', rank: 'memorial', color: 'red' },
      '8-15': { name: 'Assumption of Mary', rank: 'solemnity', color: 'white' },
      '8-16': { name: 'St. Stephen of Hungary', rank: 'memorial', color: 'white' },
      '8-19': { name: 'St. John Eudes', rank: 'memorial', color: 'white' },
      '8-20': { name: 'St. Bernard', rank: 'memorial', color: 'white' },
      '8-21': { name: 'St. Pius X', rank: 'memorial', color: 'white' },
      '8-22': { name: 'Queenship of Mary', rank: 'memorial', color: 'white' },
      '8-23': { name: 'St. Rose of Lima', rank: 'memorial', color: 'white' },
      '8-24': { name: 'St. Bartholomew', rank: 'feast', color: 'red' },
      '8-25': { name: 'St. Louis', rank: 'memorial', color: 'white' },
      '8-27': { name: 'St. Monica', rank: 'memorial', color: 'white' },
      '8-28': { name: 'St. Augustine', rank: 'memorial', color: 'white' },
      '8-29': { name: 'Martyrdom of St. John the Baptist', rank: 'memorial', color: 'red' },

      // September
      '9-3': { name: 'St. Gregory the Great', rank: 'memorial', color: 'white' },
      '9-9': { name: 'St. Peter Claver', rank: 'memorial', color: 'white' },
      '9-12': { name: 'Most Holy Name of Mary', rank: 'memorial', color: 'white' },
      '9-13': { name: 'St. John Chrysostom', rank: 'memorial', color: 'white' },
      '9-14': { name: 'Exaltation of the Holy Cross', rank: 'feast', color: 'red' },
      '9-15': { name: 'Our Lady of Sorrows', rank: 'memorial', color: 'white' },
      '9-16': { name: 'Sts. Cornelius and Cyprian', rank: 'memorial', color: 'red' },
      '9-17': { name: 'St. Robert Bellarmine', rank: 'memorial', color: 'white' },
      '9-19': { name: 'St. Januarius', rank: 'memorial', color: 'red' },
      '9-20': { name: 'Sts. Andrew Kim Taegon and Companions', rank: 'memorial', color: 'red' },
      '9-21': { name: 'St. Matthew', rank: 'feast', color: 'red' },
      '9-23': { name: 'St. Pio of Pietrelcina', rank: 'memorial', color: 'white' },
      '9-26': { name: 'Sts. Cosmas and Damian', rank: 'memorial', color: 'red' },
      '9-27': { name: 'St. Vincent de Paul', rank: 'memorial', color: 'white' },
      '9-28': { name: 'St. Wenceslaus', rank: 'memorial', color: 'white' },
      ...
      '10-2': { name: 'Holy Guardian Angels', rank: 'memorial', color: 'white' },
      '10-4': { name: 'St. Francis of Assisi', rank: 'memorial', color: 'white' },
      '10-6': { name: 'St. Bruno', rank: 'memorial', color: 'white' },
      '10-7': { name: 'Our Lady of the Rosary', rank: 'memorial', color: 'white' },
      '10-9': { name: 'St. Denis and Companions', rank: 'memorial', color: 'red' },
      '10-11': { name: 'St. John XXIII', rank: 'memorial', color: 'white' },
      '10-14': { name: 'St. Callistus I', rank: 'memorial', color: 'red' },
      '10-15': { name: 'St. Teresa of Avila', rank: 'memorial', color: 'white' },
      '10-16': { name: 'St. Hedwig', rank: 'memorial', color: 'white' },
      '10-17': { name: 'St. Ignatius of Antioch', rank: 'memorial', color: 'red' },
      '10-18': { name: 'St. Luke', rank: 'feast', color: 'red' },
      '10-19': { name: 'Sts. John de Brebeuf and Isaac Jogues', rank: 'memorial', color: 'red' },
      '10-22': { name: 'St. John Paul II', rank: 'memorial', color: 'white' },
      '10-23': { name: 'St. John of Capistrano', rank: 'memorial', color: 'white' },
      '10-24': { name: 'St. Anthony Claret', rank: 'memorial', color: 'white' },
      '10-26': { name: 'St. Damian and Saints James', rank: 'memorial', color: 'white' },
      ...
      '11-3': { name: 'St. Martin de Porres', rank: 'memorial', color: 'white' },
      '11-4': { name: 'St. Charles Borromeo', rank: 'memorial', color: 'white' },
      '11-9': { name: 'Dedication of Lateran Basilica', rank: 'feast', color: 'white' },
      '11-10': { name: 'St. Leo the Great', rank: 'memorial', color: 'white' },
      '11-11': { name: 'St. Martin of Tours', rank: 'memorial', color: 'white' },
      '11-12': { name: 'St. Josaphat', rank: 'memorial', color: 'red' },
      '11-15': { name: 'St. Albert the Great', rank: 'memorial', color: 'white' },
      '11-16': { name: 'St. Margaret of Scotland', rank: 'memorial', color: 'white' },
      '11-17': { name: 'St. Elizabeth of Hungary', rank: 'memorial', color: 'white' },
      '11-18': { name: 'Dedication of Basilicas of Sts. Peter and Paul', rank: 'memorial', color: 'white' },
      '11-21': { name: 'Presentation of Mary', rank: 'memorial', color: 'white' },
      '11-22': { name: 'St. Cecilia', rank: 'memorial', color: 'red' },
      '11-23': { name: 'St. Columban', rank: 'memorial', color: 'white' },
      '11-24': { name: 'Sts. Andrew Dung-Lac and Companions', rank: 'memorial', color: 'red' },
      '11-25': { name: 'St. Catherine of Alexandria', rank: 'memorial', color: 'red' },
      '11-30': { name: 'St. Andrew', rank: 'feast', color: 'red' },
      ...
      '12-9': { name: 'St. Juan Diego', rank: 'memorial', color: 'white' },
      '12-10': { name: 'St. John Roberts', rank: 'memorial', color: 'white' },
      '12-11': { name: 'St. Damasus I', rank: 'memorial', color: 'white' },
      '12-12': { name: 'Our Lady of Guadalupe', rank: 'memorial', color: 'white' },
      '12-13': { name: 'St. Lucy', rank: 'memorial', color: 'red' },
      '12-14': { name: 'St. John of the Cross', rank: 'memorial', color: 'white' },
      '12-21': { name: 'St. Peter Canisius', rank: 'memorial', color: 'white' },
      '12-23': { name: 'St. John of Kanty', rank: 'memorial', color: 'white' },
      ...
      '12-30': { name: 'St. Roger', rank: 'memorial', color: 'white' },
      '12-31': { name: 'St. Sylvester I', rank: 'memorial', color: 'white' },
    };
